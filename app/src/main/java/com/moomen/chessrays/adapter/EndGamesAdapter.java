...
public class EndGamesAdapter extends FirestoreRecyclerAdapter<Game, EndGamesAdapter.ViewHolder> {

    private OnItemClickListener listener;


    public EndGamesAdapter(@NonNull FirestoreRecyclerOptions<Game> options) {
        super(options);
    }

    @SuppressLint("SetTextI18n")
    @Override
    protected void onBindViewHolder(@NonNull EndGamesAdapter.ViewHolder holder, int position, @NonNull Game model) {
    ...
    @NonNull
    @Override
    public EndGamesAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        View view = layoutInflater.inflate(R.layout.end_game_item, parent, false);
        return new EndGamesAdapter.ViewHolder(view);
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ConstraintLayout constraintLayoutEndGameItem;
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            /*constraintLayoutEndGameItem = itemView.findViewById(R.id.constraintLayout_opening_game_item_id);
            constraintLayoutEndGameItem.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    if (getAdapterPosition() != RecyclerView.NO_POSITION && listener != null) {
                        DocumentSnapshot documentSnapshot = getSnapshots().getSnapshot(getAdapterPosition());

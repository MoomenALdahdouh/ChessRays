...
public class HandlingAdapter extends FirestoreRecyclerAdapter<OpeningGame, HandlingAdapter.ViewHolder> {

    private OnItemClickListener listener;


    public HandlingAdapter(@NonNull FirestoreRecyclerOptions<OpeningGame> options) {
        super(options);
    }

    @SuppressLint("SetTextI18n")
    @Override
    protected void onBindViewHolder(@NonNull HandlingAdapter.ViewHolder holder, int position, @NonNull OpeningGame model) {


        holder.moveName.setText(model.getOpeningName());

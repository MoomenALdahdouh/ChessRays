...
public class OpeningGamesAdapter extends FirestoreRecyclerAdapter<OpeningGame, OpeningGamesAdapter.ViewHolder> {

    private OnItemClickListener listener;


    public OpeningGamesAdapter(@NonNull FirestoreRecyclerOptions<OpeningGame> options) {
        super(options);
    }

    @SuppressLint("SetTextI18n")
    @Override
    protected void onBindViewHolder(@NonNull OpeningGamesAdapter.ViewHolder holder, int position, @NonNull OpeningGame model) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            score = itemView.findViewById(R.id.textView_date_id);

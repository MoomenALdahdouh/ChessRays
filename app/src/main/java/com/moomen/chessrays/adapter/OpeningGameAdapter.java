...
public class OpeningGameAdapter extends FirestoreRecyclerAdapter<OpeningGame, OpeningGameAdapter.ViewHolder> {

    private OnItemClickListener listener;


    public OpeningGameAdapter(@NonNull FirestoreRecyclerOptions<OpeningGame> options) {
        super(options);
    }

    @SuppressLint("SetTextI18n")
    @Override
    protected void onBindViewHolder(@NonNull OpeningGameAdapter.ViewHolder holder, int position, @NonNull OpeningGame model) {
